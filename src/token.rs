...
mod tests {
    use super::*;
    #[test]
    // TODO: remove whitespace from last word in sentence
    fn test_tokenizer() {
        let mut tk = Tokenizer::new("hello my { world | planet }  { world | planet }");
        assert_eq!(tk.next(), Some(Ok(Token::String("hello my ".to_string()))));
